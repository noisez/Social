    ...
    return (
        <div className="profile">
            ...
            <div className="profile__posts">
                ...
                <div className="posts__published">
                    <div className="published__item">Post-1</div>
                    <div className="published__item">Post-2</div>
                    <div className="published__item">Post-3</div>
                </div>
            </div>
        </div>
    )
